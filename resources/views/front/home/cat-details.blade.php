            ...
            <div class="col-sm-9">
                <article class="content">
                    <div class="video-container">
                        <img src="{{ asset($category->image) }}" style="height: 400px; width: 100%" alt="">
                    </div>
                    <div class="paragraph-padding">
                        <!-- /.social icon -->
                        <h1 style="font-size: 24px; line-height: 1.7">{{ $category->category_title }}</h1>

                        <p style="color:black; font-size: 14px; line-height: 1.7">{!! $category->description !!} </p>
