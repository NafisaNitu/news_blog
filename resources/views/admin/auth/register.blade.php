            ...
            <div class="col-sm-8">
                <div class="register-form-inner">
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Write Your Username">
                        ...
                        <input type="password" class="form-control" name="password_confirmation" placeholder="Rewrite Your Password Here ...">
                        <button style="margin-top: 20px;" type="submit" class="btn btn-style">Register</button>
                    </form>
                </div>
            </div>
